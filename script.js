function myFunction() {
    document.getElementById("myDIV").style.backgroundImage = "url(images/backb.png)";
}
...
let songs = [
    {songName : "Jogi - Shadi Me Jarur Aana", filePath : "songs/1.mp3", coverPath : "images/1.jpg"},
    {songName : "Maana Ke Hum Yaar Nahin", filePath : "songs/2.mp3", coverPath : "images/2.jpg"},
    {songName : "Capital Letters", filePath : "songs/3.mp3", coverPath : "images/3.jpg"},
    {songName : "Jiya Tu Bihar ke Lala", filePath : "songs/4.mp3", coverPath : "images/4.jpg"},
    {songName : "Nazm Nazm - Bareilly Ki Barfi", filePath : "songs/5.mp3", coverPath : "images/5.jpg"},
    {songName : "Jo Bhi Main - Rockstar", filePath : "songs/6.mp3", coverPath : "images/6.jpg"},
    {songName : "Kun Faaya Kun - RockStar", filePath : "songs/7.mp3", coverPath : "images/7.jpg"},
    {songName : "Tu Banja Gali Benaras", filePath : "songs/8.mp3", coverPath : "images/8.jpg"},
    {songName : "Channa Mereya", filePath : "songs/9.mp3", coverPath : "images/9.jpg"},
    {songName : "Naah - Harrdy", filePath : "songs/10.mp3", coverPath : "images/10.jpg"}
]
...
share.addEventListener('click', () => { 
    ...
    navigator.clipboard.writeText("Hey Listen to this Song : " + listeningTo +"at https://open.spotify.com/");
    alert("Copied to Clipboard : " + "Hey Listen to this Song : " + listeningTo +"at https://open.spotify.com/");
})
